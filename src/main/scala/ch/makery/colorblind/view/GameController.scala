...
class GameController(
    ...
    b37: Button, b38: Button, b39: Button, b40: Button, b41: Button, b42: Button
) {
    ...
    var colorList = List("-fx-background-color: red", "-fx-background-color: blue", "-fx-background-color: green", "-fx-background-color: yellow")
    var color = colorList(scala.util.Random.nextInt(colorList.length))

    var buttonList = List(b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b12, b13, b14, b15, b16, b17, b18, b19, b20, b21, b22, b23, b24,
